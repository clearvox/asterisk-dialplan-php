 ...
 * Only channels created by outgoing calls for the specified extension will be
 * selected for spying. If the optional context is not supplied,  the current
 ...
 * @author Yme-Jan Iedema <yme-jan@clearvox.nl>
 */
class ExtenSpy implements ApplicationInterface
{
    ...
    /**
     * @param string $exten[@context]
     * @param array $options
     */
    public function __construct($exten, array $options = array())
    {
        $this->exten   = $exten;
     ...
     * application while actively spying on a channel. If there is no channel
     * being spied on, the DTMF digit will be ignored.
     *
     *
